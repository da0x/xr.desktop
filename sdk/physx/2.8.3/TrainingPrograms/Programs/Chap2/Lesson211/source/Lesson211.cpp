...
//			             LESSON 211: 6DOF Joint Limits Springs
//
...
/**
	change text:
	from "Translation Motored" to "Translation Driver"
	from "Rotation Motored" to "Rotation Driver"
 */
char* gJointTypeString[gNumJointConfigurations] = {"Translation Limited","Translation Soft Limited",
												   ...
												   "Translation Driver", "Rotation Driver"};
