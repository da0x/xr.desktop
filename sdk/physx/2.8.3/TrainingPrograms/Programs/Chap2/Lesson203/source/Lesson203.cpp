...
/**
	\brief show a spherical joint

	Two capsules form a spherical joint
	press 'i','j','k','l' to apply force, then you will find a spherical joint works
...
{
	PrintControls();
	InitGlut(argc, argv, "Lesson 203: Spherical Joints");
    InitNx();
    glutMainLoop();
	ReleaseNx();
	return 0;
