...
void InitGlut(int argc, char** argv, char* lessonTitle)
{
    ...
    // Setup lighting
    glEnable(GL_LIGHTING);
    float AmbientColor[]    = { 0.1f, 0.15f, 0.2f, 1.0f };         glLightfv(GL_LIGHT0, GL_AMBIENT, AmbientColor);
    float DiffuseColor[]    = { 0.5f, 0.5f, 0.5f, 1.0f };         glLightfv(GL_LIGHT0, GL_DIFFUSE, DiffuseColor);
    float SpecularColor[]   = { 0.1f, 0.1f, 0.1f, 1.0f };         glLightfv(GL_LIGHT0, GL_SPECULAR, SpecularColor);
