...
NxVec3 gCameraPos(20,13,5);
NxVec3 gCameraForward(-0.9,-0.1,-0.4);
NxVec3 gCameraRight(0,0,-1);
...
void InitGlut(int argc, char** argv, char* lessonTitle)
{
    ...
    // Setup lighting
    glEnable(GL_LIGHTING);
    float AmbientColor[]    = { 0.0f, 0.1f, 0.2f, 1.0f };         glLightfv(GL_LIGHT0, GL_AMBIENT, AmbientColor);
    float DiffuseColor[]    = { 0.8f, 0.8f, 0.8f, 1.0f };         glLightfv(GL_LIGHT0, GL_DIFFUSE, DiffuseColor);
