...
void SetupDampingScene()
{
	...
	MyCloth* regularCloth1 = new MyCloth(gScene, clothDesc, 8, 7, 0.2, "nvidia.bmp");
	...
	MyCloth* regularCloth2 = new MyCloth(gScene, clothDesc, 8, 7, 0.2, "nvidia.bmp");
	...
	MyCloth* regularCloth3 = new MyCloth(gScene, clothDesc, 8, 7, 0.2, "nvidia.bmp");
