...
public:
	...
	struct Wheel
	{
		void create(NxScene& scene, const NxVec3& pos, float rad, NxActor* holder)
		{
			...
			distDesc.actor[0] = rollAxis;
			distDesc.actor[1] = holder;
			distDesc.flags |= NX_DJF_SPRING_ENABLED|NX_DJF_MAX_DISTANCE_ENABLED|NX_DJF_MIN_DISTANCE_ENABLED;
			distDesc.maxDistance = 0.11;
			distDesc.minDistance = 0;
			distDesc.spring.targetValue = 0;
			distDesc.spring.damper = 5000;
			distDesc.spring.spring = 8000000;
