...
//			                     LESSON 1102: Palm Tree
//
// ===============================================================================
// Create palm tree by soft body. And apply external acceleartion to soft body to 
// imitate the scenario of tree in wind.
// ================================================================================
#include <GL/glut.h>
#include <stdio.h>

#include "Lesson1102.h"
#include "Timing.h"
...
{
	PrintControls();
	InitGlut(argc, argv, "Lesson 1102: Palm Tree");
//	SetDataDirectory();
	InitNx();
	glutMainLoop();
	ReleaseNx();
