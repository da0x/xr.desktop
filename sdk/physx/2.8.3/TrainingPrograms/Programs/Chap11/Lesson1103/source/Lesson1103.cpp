...
//			                     LESSON 1103: Bunny Scene

// ===============================================================================
// Simulating soft body with low stretchness value.
//
// ===============================================================================
#include <GL/glut.h>
#include <stdio.h>

#include "Lesson1103.h"
#include "Timing.h"
...
void InitGlut(int argc, char** argv, char* lessonTitle)
{
	...
	float SpecularColor[]   = { 0.2f, 0.5f, 0.2f, 0.0f };         glLightfv(GL_LIGHT0, GL_SPECULAR, SpecularColor);
	float Position[]        = { 0.5f, 10.0f, 20, 1.0f };  glLightfv(GL_LIGHT0, GL_POSITION, Position);
	glEnable(GL_LIGHT0);
}
...
{
	PrintControls();
	InitGlut(argc, argv, "Lesson 1103: Bunny Scene");
//	SetDataDirectory();
	InitNx();
	glutMainLoop();
	ReleaseNx();
