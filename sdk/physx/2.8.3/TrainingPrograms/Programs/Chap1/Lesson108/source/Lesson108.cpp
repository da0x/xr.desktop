...
void InitGlut(int argc, char** argv)
{
    ...
    gMainHandle = glutCreateWindow("Lesson 108: Freeze Flags and Damping");
...
NxActor* CreatePyramid()
{
   NxActorDesc actorDesc;
	...
	// Two ways on cooking mesh: 1. Save memory, 2. Save file	
	NxInitCooking();
	// Cooking from memory
...
void InitNx()
{
	...
	//
	gSelectedActor = CreatePyramid();
	gSelectedActor->setLinearDamping(0.5);

	NxActor* box = CreateBox(NxVec3(10,0.5,0), NxVec3(1,1,1), 10);
	box->raiseBodyFlag(NX_BF_FROZEN_POS);
	box->setLinearDamping(0.5);

	box = CreateBox(NxVec3(10,0.5,10), NxVec3(1,1,1), 10);
	box->raiseBodyFlag(NX_BF_FROZEN_POS_X); 
	box->raiseBodyFlag(NX_BF_FROZEN_POS_Z);
	box->setLinearDamping(0.5);

	box = CreateBox(NxVec3(0,0.5,10), NxVec3(1,1,1), 10);
	box->raiseBodyFlag(NX_BF_FROZEN_POS_Y); 
	box->raiseBodyFlag(NX_BF_FROZEN_POS_Z);
	box->setLinearDamping(0.5);
	...
	box->raiseBodyFlag(NX_BF_FROZEN_POS_X);
	box->raiseBodyFlag(NX_BF_FROZEN_POS_Z);
	box->raiseBodyFlag(NX_BF_DISABLE_GRAVITY);
	box->setLinearDamping(0.5);

	box = CreateBox(NxVec3(-10,0.5,0), NxVec3(1,1,1), 10);
	box->raiseBodyFlag(NX_BF_FROZEN_POS_X);
	box->raiseBodyFlag(NX_BF_FROZEN_POS_Y);
	box->setLinearDamping(0.5);
