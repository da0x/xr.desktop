...
void PrintControls()
{
    ...
    printf("\n Force Controls:\n ---------------\n i = +z, k = -z\n j = +x, l = -x\n u = +y, m = -y\n");
	printf("\n Miscellaneous:\n --------------\n p   = Pause\n r   = Select Next Actor\n f   = Toggle Force Mode\n b   = Toggle Debug Wireframe Mode\n x   = Toggle Shadows\n t   = Move Focus Actor to (0,5,0)\n e   = Set Global Position\n c   = Set Linear Velocity\n v   = Set Angular Velocity\n F10 = Reset Scene\n");
}
...
void InitGlut(int argc, char** argv)
{
    ...
    gMainHandle = glutCreateWindow("Lesson 107: Rigidbody Properties");
...
NxActor* CreateBox()
{
	...
	boxDesc.dimensions.set(1.0f, 1.0f, 1.0f);
	boxDesc.localPose.t = NxVec3(0, 5.0f, 0);
