...
void InitNx()
{
	...
	gSelectedActor = CreateBox(NxVec3(1,6,0),NxVec3(0.5,0.5,0.5),10);
	
	CreateBox(NxVec3(0, 5, 0), NxVec3(0.2, 0.2, 0.2), 15);
	
	CreateBox(NxVec3(-1, 5, -1), NxVec3(0.4, 0.4, 0.4), 20);
...
{
	PrintControls();
	InitGlut(argc, argv, "Lesson 114: Rigidbody and Fluid");
    InitNx();
    glutMainLoop();
	ReleaseNx();
	return 0;
