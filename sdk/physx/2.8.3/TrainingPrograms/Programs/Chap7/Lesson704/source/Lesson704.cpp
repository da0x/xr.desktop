...
// Home Directory
char* rdir;
char returnDir[] = "../../Chapter7_Vehicles/compiler/vc8win32";
char returnDir1[] = "../../Chapter7_Vehicles/compiler/vc8win32";
...
void InitNx()
{
	...
	sceneDesc.simType				= gPhysicsSDK->getHWVersion() != NX_HW_VERSION_NONE ? NX_SIMULATION_HW : NX_SIMULATION_SW;
	...
	if (!set) { 
				...
				set = SetCurrentDirectory(&ASEfname2[0]);
				rdir = &returnDir2[0]; 
			  }
